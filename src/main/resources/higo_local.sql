...
# Dump of table higo_cart
# ------------------------------------------------------------

DROP TABLE IF EXISTS `higo_cart`;

CREATE TABLE `higo_cart` (
...
# Dump of table higo_category
# ------------------------------------------------------------

DROP TABLE IF EXISTS `higo_category`;

CREATE TABLE `higo_category` (
...
LOCK TABLES `higo_category` WRITE;
/*!40000 ALTER TABLE `higo_category` DISABLE KEYS */;

INSERT INTO `higo_category` (`id`, `name`, `type`, `parent_id`, `order_num`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `higo_category` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `higo_order`;

CREATE TABLE `higo_order` (
...
DROP TABLE IF EXISTS `higo_order_item`;

CREATE TABLE `higo_order_item` (
  `id` int(64) NOT NULL AUTO_INCREMENT COMMENT '主键id',
...
DROP TABLE IF EXISTS `higo_product`;

CREATE TABLE `higo_product` (
...
LOCK TABLES `higo_product` WRITE;
/*!40000 ALTER TABLE `imooc_mall_product` DISABLE KEYS */;

INSERT INTO `higo_product` (`id`, `name`, `image`, `detail`, `category_id`, `price`, `stock`, `status`, `create_time`, `update_time`)
VALUES
...
DROP TABLE IF EXISTS `higo_user`;

CREATE TABLE `higo_user` (
...
LOCK TABLES `higo_user` WRITE;
/*!40000 ALTER TABLE `higo_user` DISABLE KEYS */;

INSERT INTO `higo_user` (`id`, `username`, `password`, `personalized_signature`, `role`, `create_time`, `update_time`)
VALUES
...
/*!40000 ALTER TABLE `higo_user` ENABLE KEYS */;
UNLOCK TABLES;
